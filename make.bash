...
CGO_LDFLAGS="-L$CHROOT/usr/lib -L$CHROOT/lib -L$PLUGPATH/platforms -L/temp/qtwebkit-snapshots-master/WebKitBuild/Release/lib" \
CGO_LDFLAGS="$CGO_LDFLAGS -lQt5Core -lQt5DBus -lpthread -lz -lpcre16 -ldouble-conversion -lm -ldl -lgthread-2.0 -lglib-2.0 -lrt" \
CGO_LDFLAGS="$CGO_LDFLAGS -lQt5WebKit -lWTF -lWebCore -lJavaScriptCore -lANGLESupport -lWTF -lwoff2 -lsqlite3 -lbmalloc -lbrotli -lhyphen -lxslt -lxml2 -licui18n -licuuc -licudata" \
CGO_LDFLAGS="$CGO_LDFLAGS -lQt5Network -lQt5Widgets -lQt5WebKitWidgets -lQt5Gui -lQt5Core -lQt5Sql -lpthread -ljpeg -lwebp -lpng -lharfbuzz -lssl -lcrypto -lz -lGL" \
CGO_LDFLAGS="$CGO_LDFLAGS -lqoffscreen -lQt5ThemeSupport -lQt5GlxSupport -lQt5FontDatabaseSupport -lQt5ServiceSupport -lQt5EventDispatcherSupport -lQt5DBus -ldbus-1" \
...
CGO_LDFLAGS="$CGO_LDFLAGS -lm -lQt5Gui -ljpeg -lpng -lharfbuzz -lz -lbz2 -lGL -lQt5Core -lpthread -lGL -lX11 -lXext -lnettle" \
...
#CGO_LDFLAGS="$CGO_LDFLAGS -lQt5Core -lpthread -lz -lpcre16 -ldouble-conversion -lm -ldl -lgthread-2.0 -lglib-2.0 -ldbus-1 -lrt" \
#CGO_LDFLAGS="$CGO_LDFLAGS -lQt5WebKit -lWTF -lWebCore -lJavaScriptCore -lANGLESupport -lWTF -lwoff2 -lsqlite3 -lbmalloc -lbrotli -lhyphen -lxslt -lxml2 -licui18n -licuuc -licudata" \
