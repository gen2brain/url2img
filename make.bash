...
CGO_LDFLAGS="$CGO_LDFLAGS -lqoffscreen -lqgif -lqjpeg -lQt5ThemeSupport -lQt5GlxSupport -lQt5FontDatabaseSupport -lQt5ServiceSupport -lQt5EventDispatcherSupport -lQt5DBus -ldbus-1" \
